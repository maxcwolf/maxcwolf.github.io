...
// // const initAdminListeners = require('./admin/adminEventListeners')
// // const writeEditArticleList = require('./admin/writeEditArticleList')
// // const initSearchBlogs = require('./blog/search')
...
//         // initAdminListeners(db)
//         // initSearchBlogs() //adds the search blogs functionality
